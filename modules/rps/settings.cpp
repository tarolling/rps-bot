...
guild_settings_t::guild_settings_t(
    ...
    : time(now), guild_id(_guild_id), prefix(_prefix),
      ...
      role_reward_id(_role_reward_id), custom_url(_custom_url),
      language(_language),
      question_interval(_question_interval < 20 || _question_interval > 3600
                            ? 20
                            : _question_interval),
      max_normal_round(max_normal > 200 ? 200 : max_normal),
      max_quickfire_round(premium ? (max_quickfire > 200 ? 200 : max_quickfire)
                                  : (max_quickfire > 15 ? 15 : max_quickfire)),
