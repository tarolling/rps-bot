...
/**
 * @brief Allows components to be added continually to a message, without
 * worrying about component rows, maximum number of buttons per row, maximum
 * number of rows, or duplicate custom ids.
 */
