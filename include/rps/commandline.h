...
/**
 * Parse command line arguments, if passed, extracting the cluster id and max
 * clusters arguments. Note that this uses POSIX getopt, and is NOT thread safe.
 * However, once we have the arguments parsed into the return value, we never
